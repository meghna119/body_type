...
class BodyClassifierApp:
    def __init__(self):
        ...
        self.recommendation_images = {
            "Female": {
                "APPLE": {
                    "Skirt": ["images/a line skirt.png", "images/Women sketches/Skirts/wrap skirt .png","images/Women/handkerchief skirt .png", "images/Women/flip skirt .png", "images/Women/draped skirt .png"],
