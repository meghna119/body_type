        ...
        self.recommendation_images = {
            "Female": {
                ...
                "RECTANGLE": {
                    ...
                    "Sleeves": ["images/women/cap sleeve .png", "images/women/puff sleeves .png", "images/women/dolman sleeve.png", "images/women/flutter sleeve .png", "images/women/angel sleeves .png"],
