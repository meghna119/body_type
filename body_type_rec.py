...
class BodyClassifierApp:
    def __init__(self):
        ...
        self.recommendation_images = {
            "Female": {
                "APPLE": {
                    "Skirt": ["a%20line%20skirt%20.png", "images/Women sketches/Skirts/wrap skirt .png","images/Women/handkerchief skirt .png", "images/Women/flip skirt .png", "images/Women/draped skirt .png"],
